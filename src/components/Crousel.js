...
const Carousel = () => {
  ...
  const slides = [
    "https://acharyaproducts.com/wp-content/uploads/2023/01/banner1.jpg",
    "https://acharyaproducts.com/wp-content/uploads/2023/01/banner2_3.jpg",
    "https://acharyaproducts.com/wp-content/uploads/2023/01/banner3b.jpg",
    ...
    <div className="relative h-96 overflow-hidden">
      {slides.map((slide, index) => (
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center">
  <h2 className="text-white text-4xl font-bold mb-4">Shop Now</h2>
  <button className="inline-block bg-transparent hover:bg-black text-black-700 font-semibold hover:text-white py-2 px-4 border border-black hover:border-black transition-all duration-300">
    Shop Now
  </button>
</div>
          </div>
