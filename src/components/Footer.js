        ...
        <div className="relative top-16 flex flex-col justify-between border border-black md:flex md:flex-row py-10 text-white bg-black">
          <div className="flex flex-1 justify-around">
            <div className="leftFooter1">
              <span className="opacity-50 font-medium">ABOUT US</span>
              <ul className="mt-4 flex flex-col gap-2">
                <a href="">
                  <li className="footerItem">Our Story</li>
                </a>
                <a href="">
                ...
                <a href="">
                  <li className="footerItem">Dhup Agarbatti Blog</li>
                </a>
                <a href="">
                  <li className="footerItem">Bug Bounty</li>
                </a>
                <a href="">
                  <li className="footerItem">Dhup Agarbatti One</li>
                </a>
                <a href="">
                  <li className="footerItem">Dhup Agarbatti Corporate</li>
                </a>
                <a href="">
                  <li className="footerItem">Dhup Agarbatti Instamart</li>
                </a>
                <a href="">
                  <li className="footerItem">Dhup Agarbatti Genie</li>
                </a>
              </ul>
            </div>
            <div className="leftFooter2">
              ...
              <ul className="mt-4 flex flex-col gap-2">
                ...
                <a href="">
                  <li className="footerItem">Partner with us</li>
                </a>
                <a href="">
